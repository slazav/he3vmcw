...
C
C-----------------------------------------------------------------------
      COMMON /VALUES_SAVE/ ILEFT, MFLAG
...
C***
CC      DATA LOUT,NOGAUS,MAXDER,UROUND/3,1,5,7.1D-15/
      DATA LOUT,NOGAUS,MAXDER,UROUND/3,0,5,EPSU/
CCCCC       DATA LOUT,NOGAUS,MAXDER,UROUND/6,0,5,5.960464D-08/
      END
...
C FORTRAN FUNCTIONS USED..   NONE
C-----------------------------------------------------------------------
      COMMON /BSPLVN_SAVE/ DELTAM,DELTAP,J
      COMMON /SIZES/ NINT,KORD,NCC,NPDE,NCPTS,NEQN,IQUAD
...
C     SAVE EL,OLDL0,TQ,IER,NQ,L,METH,MITER
      COMMON /STIFIB_SAVE/
     *     BND,CON,CRATE,D,D1,E,EDN,ENQ1,ENQ2,ENQ3,EPSOLD,
...
C OF THE PACKAGD-SUPPLIED ROUTINE DIFFF IF MITER = 2.  FINALLY,
...
CCC      DIMENSION Y0(NEQN),Y(NEQN,MAXDER+1)
      DIMENSION Y0(N0),Y(N0,MAXDER+1)
      DO 10 I = 1,N
   10   Y0(I) = Y(I,1)
      L = JSTART + 1
      S = (TOUT - T)/H
...
C     DIFFERENTIAL EQUATIONS, PRENTICD-HALL, ENGLEWOOD CLIFFS,
C     N. J., 1971.
C
C PACKAGE ROUTINES CALLED..  NONE
C USER ROUTINES CALLED..     NONE
