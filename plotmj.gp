...
plot [0:] [-0.4:1.1]\
  "mj0.0000.dat" using 1:2 ls 1 lw 1.5,\
...
plot []\
  ...
  "mj0.0541.dat" using 1:(cos($8)) ls 1,\
  "mj0.0721.dat" using 1:(cos($8)) ls 1,\
  "mj0.0900.dat" using 1:(cos($8)) ls 1,\
  "mj0.1081.dat" using 1:(cos($8)) ls 1,\
  "mj0.1260.dat" using 1:(cos($8)) ls 1,\
  "mj0.1441.dat" using 1:(cos($8)) ls 1,\
  "mj0.1621.dat" using 1:(cos($8)) ls 1,\
  "mj0.1800.dat" using 1:(cos($8)) ls 1,\
-1/4. lc 0
